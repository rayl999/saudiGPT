        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col">
              ...
              >
                <h2 className="title title--medium title--black">
                  Team members
                </h2>
              </div>
            </div>
          ...
          <div className="row w-75 centeer">
            <div className="col-lg-3">
              <a
                href="https://api.whatsapp.com/send?phone=+966599899207"
                className="advisor "
                target="_blank"
              >
            ...
            <div className="col-lg-3">
              <a
                href="https://api.whatsapp.com/send?phone=+966551881231"
                className="advisor "
                target="_blank"
                data-aos="fade-up"
                data-aos-delay={200}
            ...
            <div className="col-lg-3">
              <a
                href="https://api.whatsapp.com/send?phone=+966550891549"
                className="advisor "
                target="_blank"
                data-aos="fade-up"
                data-aos-delay={400}
            ...
            <div className="col-lg-3">
              <a
                href="https://api.whatsapp.com/send?phone=+966555690900"
                target="_blank"
                className="advisor "
              >
                <div className="advisor__avatar" data-aos="fade-up">
