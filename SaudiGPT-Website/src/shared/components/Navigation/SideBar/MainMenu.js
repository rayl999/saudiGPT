      ...
      <div className="w-100">
        <li className="nav-item static-item">
          <div className="nav-link static-item disabled" tabIndex="-1">
            <span className="default-icon">{t("Home")}</span>
        ...
        <li className="nav-item">
          <Link  to="/Employees">
            ...
            >
              ...
              <span className="item-name">{t("Employees")}</span>
            </div>
          </Link >
        </li>
        <li className="nav-item">
          <Link  to="/Projects">
            ...
            >
              ...
              <span className="item-name">{t("Projects")}</span>
            </div>
          </Link >
        </li>
        ...
        <li className="nav-item">
          <Link  to="/Evaluations">
            ...
            >
              ...
              <span className="item-name">{t("Evaluations")}</span>
            </div>
          </Link >
        </li>
        <li className="nav-item">
          <Link  to="/Departments">
            ...
            >
              ...
              <span className="item-name">{t("Departments")}</span>
            </div>
          </Link >
        </li>
        <li>
